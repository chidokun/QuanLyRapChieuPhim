...
public class frmSuatChieu extends Shell {
	...
	public frmSuatChieu(Display display, String title, SuatChieu sc) {
		...
		txtMaSuatChieu.setBounds(109, 99, 141, 24);
		...
		cbTrangThai.setBounds(358, 193, 141, 23);
		...
		composite.setBounds(0, 422, 529, 56);
		...
		cbTenPhim.setBounds(109, 147, 141, 23);
		...
		gridSuatPhim.setBounds(32, 275, 467, 141);
		...
		dateTime_Gio.setBounds(109, 192, 141, 24);
		...
		txtMaSuatPhim.setBounds(109, 235, 141, 25);
		isInsert = sc == null;
		this.sc = sc;
		createContents();
	...
	public void layThongTinSuatPhim(String maPhim)
	{
		try {
			...
			for (SuatPhim i : arr) {
				...
				item.setText(new String[] {  i.getMaSuatPhim(),i.getMaDinhDang(),i.getMaHinhThuc(),i.getMaNgonNgu()});
			}
	...
	public SuatChieu laySuatChieu_them() {
		return new SuatChieu(txtMaSuatChieu.getText(), 
				DateF.toDate(dateTime.getYear(), dateTime.getMonth(), dateTime.getDay(),dateTime_Gio.getHours(),dateTime_Gio.getMinutes(),dateTime_Gio.getSeconds()),
